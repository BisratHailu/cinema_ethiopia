...
class EthioScroll extends StatefulWidget {
  const EthioScroll({Key key}) : super(key: key);

  @override
  _EthioScrollState createState() => _EthioScrollState();
}

class _EthioScrollState extends State<EthioScroll> {
